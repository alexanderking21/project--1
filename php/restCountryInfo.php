...
// Define the RestCountryInfoAPI class which extends the httpHelper class
class RestCountryInfoAPI extends httpHelper
{
    ...
    private function respond()
    {
        try {
            ...
            // Define the URL for retrieving country information
            $url = 'https://restcountries.com/v3.1/all';

            // Make a cURL request to retrieve the country information
...
// Create a new instance of the RestCountryInfoAPI class
